...
<html>
 ...
 $H = explode("," ,$pro['image'] );
                    ?>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/img/<?=$H[array_rand($H)]?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/img/<?=$H[array_rand($H)]?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/img/<?=$H[array_rand($H)]?>" alt="..."></div>
                    <div class="owl-thumb-item flex-fill mb-2"><img class="w-100" src="admin/img/<?=$H[array_rand($H)]?>" alt="..."></div>
                  </div>
                </div>
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block" href="admin/img/<?=$H[array_rand($H)]?>" data-lightbox="product" title="Product item 1">
                    <img class="img-fluid" src="admin/img/<?=$H[array_rand($H)]?>" alt="..."></a><a class="d-block" href="admin/img/<?=$H[array_rand($H)]?>" data-lightbox="product" title="Product item 2">
                      <img class="img-fluid" src="admin/img/<?=$H[array_rand($H)]?>" alt="..."></a><a class="d-block" href="admin/img/<?=$H[array_rand($H)]?>" data-lightbox="product" title="Product item 3">
                        <img class="img-fluid" src="admin/img/<?=$H[array_rand($H)]?>" alt="..."></a><a class="d-block" href="admin/img/<?=$H[array_rand($H)]?>" data-lightbox="product" title="Product item 4">
                          <img class="img-fluid" src="admin/img/<?=$H[array_rand($H)]?>" alt="..."></a></div>
                </div>
              </div>
            </div>
            <!-- PRODUCT DETAILS-->
            <div class="col-lg-6">
              ...
              <p class="text-small mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut ullamcorper leo, eget euismod orci. Cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus. Vestibulum ultricies aliquam convallis.</p>
              <div class="row align-items-stretch mb-4">3
