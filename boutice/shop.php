          ...
          <div class="modal-content">
            <div class="modal-body p-0">
              <div class="row align-items-stretch">
                <div class="col-lg-6 p-lg-0"><a class="product-view d-block h-100 bg-cover bg-center" style="background: url(img/product-5.jpg)" href="boutice/img/product-5.jpg" data-lightbox="productview" title="Red digital smartwatch"></a><a class="d-none" href="img/product-5-alt-1.jpg" title="Red digital smartwatch" data-lightbox="productview"></a><a class="d-none" href="img/product-5-alt-2.jpg" title="Red digital smartwatch" data-lightbox="productview"></a></div>
                <div class="col-lg-6">
...
$select_Cat = "SELECT * FROM category WHERE parent = 0 ";
...
$select_Pro = "SELECT * FROM category";
$result_Pro = $conn -> query($select_Pro);

while($Pro_row = $result_Pro->fetch_assoc()){
  
  if($Pro_row['parent']==$Row['id']){?>


    <li class="mb-2"><a class="reset-anchor" href="#"><?=$Pro_row['name']?></a></li>
...
$select="SELECT * FROM products limit 3 OFFSET $off ";
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white badge-"></div><a class="d-block" href="detail.php?id=<?=$row['id'];?>">
                          
                      <?php  //$image = explode("," ,$row['image'] );?>
                        <img class="img-fluid w-100" src="/boutice/img/<?=$row['image'];//[array_rand($image)];?>" style="height:200px" alt="..."></a>
                        ...
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline">
                            ...
                            <li class="list-inline-item m-0 p-0">
                              ...
                              <a class="btn btn-sm btn-dark" href="do_add.php?id=<?=$row['id']?>">Add to cart</a></li>
...
$selectPro= "SELECT id FROM products";
$resultPro= $conn -> query($selectPro);
$num = $resultPro->num_rows;
$counts = $num/3 ;
...
?>
                ...
                <nav aria-label="Page navigation example">
                  <ul class="pagination justify-content-center justify-content-lg-end">
                    ...
                    if($pages>1){
?>
                      <li class="page-item"><a class="page-link" href="shop.php?page=<?= $pages -1 ;?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
                <?php    }
                    ?>
...
if($pages<$counts){?>
  <li class="page-item"><a class="page-link" href="shop.php?page=<?= $pages+1 ;?>" aria-label=""><span aria-hidden="true">»</span></a></li>
